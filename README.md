...
Our most updated implementation can be found in the project: https://github.com/ItakEjgo/weighted_distance_oracle. Please kindly cite the paper in the Reference if you used our code. 
